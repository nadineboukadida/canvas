...
ngOnInit(): void {
  ...
  if(this.name!="john" && this.name!="larry"){
   ...
   this.top= canvas.getBoundingClientRect().y
    ...
    context.fillRect(0,0,this.playerService.chartInfo.chartWidth,this.playerService.chartInfo.chartHeight);
if(this.name=="john")
{num=0
this.playerService.drawPlayer(context,this.johnPoints,this.dates,"cyan")
this.playerService.addTitleToChart(context, "John Score");

}
else if (this.name=="larry")
{num=1
this.playerService.drawPlayer(context,this.larryPoints,this.dates,"pink")
this.playerService.addTitleToChart(context, "Larry Score");

}
else
{this.playerService.drawBarChart(context,this.johnPoints,this.larryPoints,this.dates);
...
num=2}
    ...
    canvas.addEventListener("click",(e)=> {
      this.playerService.handleMouseMove(e,context,this.johnPoints,this.larryPoints,this.top,this.left,num)
